...
//    }
//    
//    RenderWindow window1(VideoMode(1400, 800), "Game!");
...
//    float scaleX1 = static_cast<float>(window1.getSize().x) / backpic1.getSize().x;
//    float	scaleY1 = static_cast<float>(window1.getSize().y) / backpic1.getSize().y;
